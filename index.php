...
<sectio class="nav">
  <h1>PANTOMATH :)</h1>
  <h3 class="span loader"><span class="m">A</span><span class="m">B</span><span class="m">D</span><span class="m">A</span><span class="m">L</span><span class="m">L</span><span class="m">A</span><span class="m">H</span><span class="m">&nbsp;</span><span class="m">A</span><span class="m">L</span><span class="m">R</span><span class="m">A</span><span class="m">M</span><span class="m">A</span><span class="m">H</span><span class="m">I</span></h3>
  <div class="nav-container"><a class="nav-tab" href="#tab-svelte">LET'S START</a><a class="nav-tab" href="#tab-esbuild">Register</a><a class="nav-tab" href="#tab-next">ABOUT</a><a class="nav-tab" href="#tab-typescript">OUR TEAM</a><a class="nav-tab" href="#tab-vite">SUPPORT</a><span class="nav-tab-slider"></span></div>
</sectio>
<main class="main">
  ...
  <section class="slider" id="tab-typescript">
    <h1>OUR TEAM</h1>
    <h2>ABDALLAH ALRAMAHI</h2>
  </section>
  <section class="slider" id="tab-vite">
    <h1>CONNECT WITH US</h1>
    <h2>abdullah1999alramahi@gmail.com</h2>
